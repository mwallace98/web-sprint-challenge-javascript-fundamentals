...
// It can access it because they are both inside the function
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const newArray = array.filter(obj => obj.population < 5)
    return newArray;
  }
  ...
  */
  ...
  function USApop(arr){
    const animalPop = arr.reduce((total, pop) => {
...
console.log('task 3 Request 1', add(1,2));
...
function multiply(num1,num2){
  ...
  console.log('Task 3 Request 2',multiply(2,2));
...
function greeting(firstName,lastName){
  ...
  console.log('Task 3 Request 5',greeting('Matt', 'Wallace'))
